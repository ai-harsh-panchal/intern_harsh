...
class Library(models.Model):
    ...
    book_count = fields.Integer(string='Book Count', compute='compute_book_count')
    ...
    def compute_book_count(self):
        ...
        """
        for rec in self:
            borrowed_books = rec.book_id.filtered(lambda book: book.status == 'borrowed')
    ...
    def action_get_books_record(self):
        ...
        return {
            ...
            'domain': [('id', 'in', self.book_id.ids), ('status', '=', 'borrowed')],
